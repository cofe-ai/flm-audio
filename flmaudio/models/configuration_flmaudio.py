...
class FLMAudioConfig(PretrainedConfig):
    ...
    Args:
        vocab_size (`int`, *optional*, defaults to 32000):
            Vocabulary size of the FLMAudio model. Defines the number of different tokens that can be represented by the
            `inputs_ids` passed when calling [`FLMAudio`]
        ...
        max_position_embeddings (`int`, *optional*, defaults to 2048):
            The maximum sequence length that this model might ever be used with. FLMAudio supports up to 4096 tokens.
    ...
    # Default tensor parallel plan for base model `FLMAudio`
    base_model_tp_plan = {
